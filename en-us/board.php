...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css_e/global.css">
        <link rel="stylesheet" type="text/css" href="../css_e/board.css">
...
?>
        <div class="main">
            <div class="article_content">
                <div class="path_area">
                    <a href="./investor.html" class="path_item">Investor Relations</a>
                    <span class="arrow">&gt;</span>
                    <a href="javascript:;" class="path_item current">Board</a>
                </div>
