...
<body>
    <?php
    $fk_merchant_id = '171615'; // free-kassa.ru http://free-kassa.ru/merchant/cabinet/help/
    $fk_merchant_key = 'yyvvqmph'; // http://free-kassa.ru/merchant/cabinet/profile/tech.php
        ...
        <aside id="left-panel" class="left-panel">
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    ...
                    <h4 class="user_mail_pole" style="color:white; text-align:center;font-size:18px;font-weight: 500;padding-top:20px;"></h4>
                                            ...
                                            <form action="http://www.free-kassa.ru/merchant/cash.php" method="GET" >
                                                <div class="form-group">
                                                    <label for="cc-payment" class="control-label mb-1">Payment
                                                        amount</label>
                                                        <input id="cc-pament sum oa" type="text" name="oa"  onchange="calculate()" onkeyup="calculate()" onfocusout="calculate()" onactivate="calculate()" ondeactivate="calculate()" reqired>
                                                </div>
                                                <div id="error"></div>
                                                <div>
                                ...
                                <div class="card-body card-block">
                                    <form action="" method="post" id="form-horizontal" class="form-horizontal">
                                        <div class="row form-group">
                                            ...
                                            <input type="number" id="hf-tokens"
                                                    name="hf-tokens" placeholder="How much tokens"
                                                    class="form-control"><span class="help-block">only integers</span></div>
                                        </div>
